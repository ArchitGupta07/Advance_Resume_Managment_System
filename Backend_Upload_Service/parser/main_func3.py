...
def get_closest_location_to_personal_details(text,words):
    # get personal details from extractor
    return
...
# <<<<<<< HEAD
    ...
    try:
        ...
        job_roles = list(set(extract_prev_job_roles(workExText)))
        print('\n Job Roles \n', job_roles, '\n End Job Roles \n')
        ...
        rawLocations = extract_locations_from_text(remove_prepositions(emergency_text).lower());
        print('Raw Extraction: ', rawLocations,'\n\n')
        cities_list = list(rawLocations.keys())
        print('after raw extraction: ', cities_list)

        get_closest_location_to_present(workExText,cities_list)
        get_closest_location_to_current(workExText,cities_list)
        get_closest_location_to_till_date(workExText,cities_list)
        get_closest_location_to_email(workExText,cities_list,emailForLocation[0])
        # get_closest_location_to_personal_details(emergency_text.lower(),cities_list)
